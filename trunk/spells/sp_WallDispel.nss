...
// End of Spell Cast Hook
    ...
    object oAoE = GetAreaOfEffectObject(lTarget, "VFX_PER_WALLDISPEL");
    SetAllAoEInts(SPELL_GREAT_WALL_OF_DISPEL, oAoE, PRCGetSpellSaveDC(SPELL_GREAT_WALL_OF_DISPEL, SPELL_SCHOOL_ABJURATION), 0, nCasterLevel);
