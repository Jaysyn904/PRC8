/*:://////////////////////////////////////////////
//:: Spell Name Repulsion Shell : On Enter (3M)
//:: Spell FileName PHS_S_RepulsionC
//:://////////////////////////////////////////////
...
void main()
{
    ...
    // Distance we need to move them back is going to be 3M away, so out of the
    // AOE.

    // Therefore, this is 3 - Current Distance.
    float fDistance =  3.0 - GetDistanceBetween(oCaster, oTarget);
