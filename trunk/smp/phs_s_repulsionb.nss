/*:://////////////////////////////////////////////
//:: Spell Name Repulsion Shell : On Enter (2M)
//:: Spell FileName PHS_S_RepulsionB
//:://////////////////////////////////////////////
...
void main()
{
    ...
    // Distance we need to move them back is going to be 2M away, so out of the
    // AOE.

    // Therefore, this is 2 - Current Distance.
    float fDistance =  2.0 - GetDistanceBetween(oCaster, oTarget);
