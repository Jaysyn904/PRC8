...
void main()
{
    ...
    if(!GetLocalInt(oPC, METAPSIONIC_WIDEN_VAR) &&
    ...
    SetLocalInt(oPC, METAPSIONIC_WIDEN_VAR, !GetLocalInt(oPC, METAPSIONIC_WIDEN_VAR));
    FloatingTextStringOnCreature(GetStringByStrRef(16826544) + " " + (GetLocalInt(oPC, METAPSIONIC_WIDEN_VAR) ? GetStringByStrRef(63798/*Activated*/):GetStringByStrRef(63799/*Deactivated*/)), oPC, FALSE);
}