...
int GetArcanePRCLevels(object oCaster, int nCastingClass = CLASS_TYPE_INVALID)
{
	...
	//:: counts as a prestige class, otherwise RHD is used instead of bard levels.		
		...
		//:: Special handling for Bard / Sublime Chord
...
//:: End Bard Arcane PrC casting calculations
	...
	{    
		if(GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_FEY, oCaster))
			nArcane += GetLevelByClass(CLASS_TYPE_SUBLIME_CHORD, oCaster);
...
//:: End Assassin Arcane PrC casting calculations
    ...
    {    
		if(GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_BEGUILER, oCaster))
			nArcane += GetLevelByClass(CLASS_TYPE_SUBLIME_CHORD, oCaster);
...
//:: End Dread Necromancer Arcane PrC casting calculations 
    ...
    {    
		if(GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_DUSKBLADE, oCaster))
			nArcane += GetLevelByClass(CLASS_TYPE_SUBLIME_CHORD, oCaster);
...
//:: counts as a prestige class, otherwise RHD is used instead of sorc levels.		
		...
		if(GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_SORCERER, oCaster))
			nArcane += GetLevelByClass(CLASS_TYPE_SUBLIME_CHORD, oCaster);
...
//:: Adding PrC caster levels to the racial caster level.
		...
		if(GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_MONSTROUS, oCaster) 
		|| GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_ABERRATION, oCaster) 
		|| GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_OUTSIDER, oCaster) 
		|| GetHasFeat(FEAT_SUBLIME_CHORD_SPELLCASTING_SHAPECHANGER, oCaster))
			nArcane += GetLevelByClass(CLASS_TYPE_SUBLIME_CHORD, oCaster);
