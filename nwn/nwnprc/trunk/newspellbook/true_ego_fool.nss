...
Specifics: You gain a luck bonus on saving throws equal to the number of morphic cadences you know. This benefit lasts for 1 round per class level. 
Use: Selected.
*/
...
// End of Spell Cast Hook
    ...
    if(utter.bCanUtter)
    {
        ...
        effect eDR = EffectSavingThrowIncrease(SAVING_THROW_ALL, nHeal, SAVING_THROW_TYPE_ALL);
