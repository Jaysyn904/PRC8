...
//:: Spell FileName PHS_S_ProtFromCh
//:://////////////////////////////////////////////
...
//:://////////////////////////////////////////////
    ...
    This spell wards a creature from attacks by chaotic creatures and from
    mental control. It creates a magical barrier around the subject. The barrier
    ...
    creature, making them immune to Charm and Domination caused by chaotic
...
{
    // Spell Hook Check.
    if(!PHS_SpellHookCheck(PHS_SPELL_PROTECTION_FROM_CHAOS)) return;
    ...
    if(PHS_RemoveProtectionFromAlignment(oTarget, ALIGNMENT_CHAOTIC, 1)) return;

    // Signal spell cast at
    PHS_SignalSpellCastAt(oTarget, PHS_SPELL_PROTECTION_FROM_CHAOS, FALSE);
