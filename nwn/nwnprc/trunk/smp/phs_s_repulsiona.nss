/*:://////////////////////////////////////////////
//:: Spell Name Repulsion Shell : On Enter (1M)
//:: Spell FileName PHS_S_RepulsionA
//:://////////////////////////////////////////////
...
void main()
{
    ...
    // Distance we need to move them back is going to be 1M away, so out of the
    // AOE.

    // Therefore, this is 1 - Current Distance.
    float fDistance =  1.0 - GetDistanceBetween(oCaster, oTarget);
