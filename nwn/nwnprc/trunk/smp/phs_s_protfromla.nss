...
//:: Spell FileName PHS_S_ProtFromLa
//:://////////////////////////////////////////////
...
//:://////////////////////////////////////////////
    ...
    This spell wards a creature from attacks by lawful creatures and from mental
    ...
    creature, making them immune to Charm and Domination caused by lawful
...
{
    // Spell Hook Check.
    if(!PHS_SpellHookCheck(PHS_SPELL_PROTECTION_FROM_LAW)) return;
    ...
    // Delcare effects
    effect eDur = EffectVisualEffect(PHS_VFX_DUR_PROTECTION_CHAOS_MINOR);
    ...
    eLink = VersusAlignmentEffect(eLink, ALIGNMENT_LAWFUL);

    // Remove previous castings
    if(PHS_RemoveProtectionFromAlignment(oTarget, ALIGNMENT_LAWFUL, 1)) return;

    // Signal spell cast at
    PHS_SignalSpellCastAt(oTarget, PHS_SPELL_PROTECTION_FROM_LAW, FALSE);
