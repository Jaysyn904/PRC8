...
int ArchmageMarkerFeats()
{
    ...
    {
		int iArchClass 	= GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_FEY)
						+ GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_ABERRATION)
						+ GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_MONSTROUS)
						+ GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_OUTSIDER)
						+ GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_SHAPECHANGER)
						+ GetHasFeat(FEAT_ARCHMAGE_SPELLCASTING_BEGUILER)
...
int WarpriestMarkerFeats()
{
    ...
    {
		int nWarpriest	= GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_ARCHIVIST)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_BLACKGUARD)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_BLIGHTER)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_CLERIC)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_DOMIEL)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_DRUID)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_FAVOURED_SOUL)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_HEALER)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_JUSTICEWW)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_KNIGHT_CHALICE)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_KNIGHT_MIDDLECIRCLE)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_NENTYAR_HUNTER)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_OCULAR)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_PALADIN)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_RANGER)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_OASHAMAN)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_SOHEI)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_SOL)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_SPSHAMAN)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_UR_PRIEST)
						+ GetHasFeat(FEAT_WARPRIEST_SPELLCASTING_VASSAL);
