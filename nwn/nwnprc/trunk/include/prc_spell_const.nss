...
//:: Epic Level Handbook
const int EPIC_SPELL_SUMMON_PARAGON 		= 4072;
const int EPIC_SPELL_SUMMON_AIR_PARAGON		= 4073;
const int EPIC_SPELL_SUMMON_EARTH_PARAGON	= 4074;
const int EPIC_SPELL_SUMMON_FIRE_PARAGON	= 4075;
const int EPIC_SPELL_SUMMON_WATER_PARAGON	= 4076;
