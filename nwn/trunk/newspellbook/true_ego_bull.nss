...
Specifics: You gain an insight bonus to your Strength score equal to the number of morphic cadences you know for 1 minute.
Use: Selected.
*/
...
// End of Spell Cast Hook
    ...
    if(utter.bCanUtter)
    {
        ...
        effect eDR = EffectAbilityIncrease(ABILITY_STRENGTH, nHeal);
