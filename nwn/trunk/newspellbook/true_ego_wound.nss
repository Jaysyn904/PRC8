...
Specifics: You gain fast healing equal to the number of morphic cadences you know. This benefit lasts for 1 round per class level. 
Use: Selected.
*/
...
// End of Spell Cast Hook
    ...
    if(utter.bCanUtter)
    {
        ...
        effect eDR = EffectRegenerate(nHeal, 6.0);
